...
exports.run = async (client, message, args) => {
    ...
    const filter = (reaction, user) => {
        return [':white_check_mark:', '746332774771982369'].includes(reaction.emoji.name) && user.id === rochelle1.id;
    ...
    await mesaj.react("746332774771982369") /// emoji id 
    await mesaj.react("746332774771982369")/// emoji id 
    mesaj.awaitReactions(filter, {
        ...
        if (reaction.emoji.name === ':white_check_mark:') {  /// emoji ismi 
