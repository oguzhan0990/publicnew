...
if(!message.member.roles.has('745539096973410411') && !message.member.hasPermission('ADMINISTRATOR')) return message.reply('Kullanmağa Yetkin Yetmiyor Bilader')
  let enAltYetkiliRolü = message.guild.roles.get("745539097145245697"); // en alttaki rol id
