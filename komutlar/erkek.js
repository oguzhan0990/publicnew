...
rochelle.setNickname(`SΞD ${isim} ${yas}`)
  rochelle.addRole('745539097220612102'); // erkek 1
  rochelle.addRole('745539097220612104'); // erkek 1
...
db.add(`erkek.${message.author.id}`, 1);
    const kanal = message.guild.channels.find(c => c.id == "745539098281902144") 
  ...
  .setDescription(`** ${rochelle.user} Adlı Üye <@&745539097220612102> <@&745539097220612104> Rolüyle Kayıt Oldu.** `)
